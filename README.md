...
![Autonomous Drone System](assets/images/drone-project.jpg) 
> *Note: Replace the image path above with your actual image path. If you don't have a picture for a project, just delete the `![Alt text](path)` line.*
...
**Key Features:**
* Engineered and built quadcopter and hexacopter
...
**Tech Stack:** Python | PyMAVLink | Jetson Inference | MQTT | PX4 / SITL
...
**Tech Stack:**
C | ESP-IDF | FreeRTOS | Wi-Fi | HTTPS | MQTT | SNTP | JSON | Embedded Systems
...
**Tech Stack:** C++ | libcamera | Raspberry Pi CM4 | I2C / BME280 | Linux | MQTT / Cloud Sync
...
**Tech Stack**
C++ | ROS 2 | PX4 / SITL | Gazebo | OpenCV | Python | MAVLink
